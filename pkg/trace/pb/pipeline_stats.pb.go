...
type ClientPipelineStatsPayload struct {
	...
	Stats   []ClientPipelineStatsBucket `protobuf:"bytes,3,rep,name=stats" json:"stats"`
}
...
func (m *ClientGroupedPipelineStats) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Sketch) > 0 {
		data[i] = 0x2a
		i++
		i = encodeVarintPipelineStats(data, i, uint64(len(m.Sketch)))
		i += copy(data[i:], m.Sketch)
	}
	return i, nil
}
...
var fileDescriptorPipelineStats = []byte{
	...
	,
}

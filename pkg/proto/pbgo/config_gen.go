...
func (z *ClientLatestConfigsRequest) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "ConnectedTracers":
			var zb0006 uint32
			zb0006, err = dc.ReadArrayHeader()
			if err != nil {
				err = msgp.WrapError(err, "ConnectedTracers")
				return
			}
			if cap(z.ConnectedTracers) >= int(zb0006) {
				z.ConnectedTracers = (z.ConnectedTracers)[:zb0006]
			} else {
				z.ConnectedTracers = make([]*TracerInfo, zb0006)
			}
			for za0003 := range z.ConnectedTracers {
				if dc.IsNil() {
					err = dc.ReadNil()
					if err != nil {
						err = msgp.WrapError(err, "ConnectedTracers", za0003)
						return
					}
					z.ConnectedTracers[za0003] = nil
				} else {
					if z.ConnectedTracers[za0003] == nil {
						z.ConnectedTracers[za0003] = new(TracerInfo)
					}
					err = z.ConnectedTracers[za0003].DecodeMsg(dc)
					if err != nil {
						err = msgp.WrapError(err, "ConnectedTracers", za0003)
						return
					}
...
func (z *ClientLatestConfigsRequest) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "ConnectedTracers"
	err = en.Append(0xb0, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x65, 0x64, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x73)
	if err != nil {
		return
	}
	err = en.WriteArrayHeader(uint32(len(z.ConnectedTracers)))
	if err != nil {
		err = msgp.WrapError(err, "ConnectedTracers")
		return
	}
	for za0003 := range z.ConnectedTracers {
		if z.ConnectedTracers[za0003] == nil {
			...
			err = z.ConnectedTracers[za0003].EncodeMsg(en)
			if err != nil {
				err = msgp.WrapError(err, "ConnectedTracers", za0003)
				return
			}
...
func (z *ClientLatestConfigsRequest) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "ConnectedTracers"
	o = append(o, 0xb0, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x65, 0x64, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x73)
	o = msgp.AppendArrayHeader(o, uint32(len(z.ConnectedTracers)))
	for za0003 := range z.ConnectedTracers {
		if z.ConnectedTracers[za0003] == nil {
			o = msgp.AppendNil(o)
		} else {
			o, err = z.ConnectedTracers[za0003].MarshalMsg(o)
			if err != nil {
				err = msgp.WrapError(err, "ConnectedTracers", za0003)
				return
			}
		...
		case "ConnectedTracers":
			...
			for za0003 := range z.ConnectedTracers {
				if msgp.IsNil(bts) {
					...
					bts, err = z.ConnectedTracers[za0003].UnmarshalMsg(bts)
					if err != nil {
						err = msgp.WrapError(err, "ConnectedTracers", za0003)
						return
					}
...
func (z *ClientLatestConfigsRequest) Msgsize() (s int) {
	s = 1 + 9 + msgp.StringPrefixSize + len(z.Hostname) + 13 + msgp.StringPrefixSize + len(z.AgentVersion) + 29 + msgp.Uint64Size + 25 + msgp.Uint64Size + 27 + msgp.Uint64Size + 9 + msgp.ArrayHeaderSize + (len(z.Products) * (msgp.Int32Size)) + 12 + msgp.ArrayHeaderSize + (len(z.NewProducts) * (msgp.Int32Size)) + 17 + msgp.ArrayHeaderSize
	for za0003 := range z.ConnectedTracers {
		if z.ConnectedTracers[za0003] == nil {
			s += msgp.NilSize
		} else {
			s += z.ConnectedTracers[za0003].Msgsize()
		}
	}
	...
	for zb0001 > 0 {
		...
		case "TracerInfo":
			if dc.IsNil() {
				err = dc.ReadNil()
				if err != nil {
					err = msgp.WrapError(err, "TracerInfo")
					return
				}
				z.TracerInfo = nil
			} else {
				if z.TracerInfo == nil {
					z.TracerInfo = new(TracerInfo)
				}
				err = z.TracerInfo.DecodeMsg(dc)
				if err != nil {
					err = msgp.WrapError(err, "TracerInfo")
					return
				}
...
func (z *GetConfigsRequest) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 7
	// write "Product"
	err = en.Append(0x87, 0xa7, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74)
	if err != nil {
		return
	}
	...
	// write "TracerInfo"
	err = en.Append(0xaa, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f)
	if err != nil {
		return
	}
	if z.TracerInfo == nil {
...
func (z *GetConfigsRequest) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 7
	// string "Product"
	o = append(o, 0x87, 0xa7, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74)
	...
	o = msgp.AppendUint64(o, z.CurrentDirectorRootVersion)
	// string "TracerInfo"
	o = append(o, 0xaa, 0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f)
	if z.TracerInfo == nil {
		o = msgp.AppendNil(o)
	} else {
		o, err = z.TracerInfo.MarshalMsg(o)
		if err != nil {
			err = msgp.WrapError(err, "TracerInfo")
			return
		}
	...
	for zb0001 > 0 {
		...
		case "TracerInfo":
			if msgp.IsNil(bts) {
				...
				bts, err = z.TracerInfo.UnmarshalMsg(bts)
				if err != nil {
					err = msgp.WrapError(err, "TracerInfo")
					return
				}
...
func (z *GetConfigsRequest) Msgsize() (s int) {
	s = 1 + 8 + msgp.Int32Size + 28 + msgp.Uint64Size + 27 + msgp.Uint64Size + 11
	if z.TracerInfo == nil {
		s += msgp.NilSize
	} else {
		s += z.TracerInfo.Msgsize()
	}
	s += 21 + 1 + 17 + msgp.BytesPrefixSize + len(z.XXX_unrecognized) + 14 + msgp.Int32Size
	return
}
...
func (z *SubscribeConfigRequest) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 6
	// write "CurrentConfigSnapshotVersion"
	err = en.Append(0x86, 0xbc, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e)
	if err != nil {
		return
	}
	err = en.WriteUint64(z.CurrentConfigSnapshotVersion)
...
func (z *SubscribeConfigRequest) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 6
	// string "CurrentConfigSnapshotVersion"
	o = append(o, 0x86, 0xbc, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e)
	o = msgp.AppendUint64(o, z.CurrentConfigSnapshotVersion)
	// string "Product"
...
func (z *SubscribeConfigRequest) Msgsize() (s int) {
	s = 1 + 29 + msgp.Uint64Size + 8 + msgp.Int32Size + 11
	if z.TracerInfo == nil {
		s += msgp.NilSize
	} else {
		s += z.TracerInfo.Msgsize()
...
// DecodeMsg implements msgp.Decodable
func (z *TracerInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *TracerInfo) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 8
	// write "RuntimeId"
...
// MarshalMsg implements msgp.Marshaler
func (z *TracerInfo) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 8
	// string "RuntimeId"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *TracerInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *TracerInfo) Msgsize() (s int) {
	s = 1 + 10 + msgp.StringPrefixSize + len(z.RuntimeId) + 10 + msgp.StringPrefixSize + len(z.ServiceId) + 4 + msgp.StringPrefixSize + len(z.Env) + 8 + msgp.StringPrefixSize + len(z.Version) + 8 + msgp.Int32Size + 21 + 1 + 17 + msgp.BytesPrefixSize + len(z.XXX_unrecognized) + 14 + msgp.Int32Size
	return
}
